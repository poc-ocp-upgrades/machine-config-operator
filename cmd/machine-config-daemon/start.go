...
func runStartCmd(cmd *cobra.Command, args []string) {
	...
	if startOpts.onceFrom != "" {
		...
		dn, err = daemon.New(startOpts.rootMount, startOpts.nodeName, operatingSystem, daemon.NewNodeUpdaterClient(), startOpts.onceFrom, startOpts.skipReboot, mcClient, kubeClient, startOpts.kubeletHealthzEnabled, startOpts.kubeletHealthzEndpoint, nodeWriter, exitCh, stopCh)
		if err != nil {
