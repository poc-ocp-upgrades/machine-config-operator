...
var (
	startCmd	= &cobra.Command{Use: "start", Short: "Starts Machine Config Operator", Long: "", Run: runStartCmd}
	startOpts	struct {
		kubeconfig	string
		imagesFile	string
	}
