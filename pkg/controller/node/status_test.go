...
func newNode(name string, currentConfig, desiredConfig string) *corev1.Node {
	...
	return &corev1.Node{ObjectMeta: metav1.ObjectMeta{Name: name, Annotations: annos}}
}
...
func TestGetUpdatedMachines(t *testing.T) {
	...
	tests := []struct {
		...
		updated		[]*corev1.Node
	}{{nodes: []*corev1.Node{}, currentConfig: "v1", updated: nil}, {nodes: []*corev1.Node{newNode("node-0", "v0", "v0"), newNode("node-1", "v1", "v1"), newNode("node-2", "v0", "v1")}, currentConfig: "v1", updated: []*corev1.Node{newNode("node-1", "v1", "v1")}}, {nodes: []*corev1.Node{newNode("node-0", "v0", "v1"), newNode("node-1", "v1", "v1"), newNode("node-2", "v1", "v1")}, currentConfig: "v1", updated: []*corev1.Node{newNode("node-1", "v1", "v1"), newNode("node-2", "v1", "v1")}}, {nodes: []*corev1.Node{newNode("node-0", "v0", "v1"), newNode("node-1", "v1", "v1"), newNodeWithReady("node-2", "v1", "v1", corev1.ConditionFalse)}, currentConfig: "v1", updated: []*corev1.Node{newNode("node-1", "v1", "v1"), newNodeWithReady("node-2", "v1", "v1", corev1.ConditionFalse)}}}
...
func TestGetReadyMachines(t *testing.T) {
	...
	tests := []struct {
		...
		currentConfig	string
		ready		[]*corev1.Node
	}{{nodes: []*corev1.Node{}, currentConfig: "v1", ready: nil}, {nodes: []*corev1.Node{newNodeWithReady("node-0", "v0", "v0", corev1.ConditionTrue), newNodeWithReady("node-1", "v1", "v1", corev1.ConditionTrue), newNodeWithReady("node-2", "v0", "v1", corev1.ConditionFalse)}, currentConfig: "v1", ready: []*corev1.Node{newNodeWithReady("node-1", "v1", "v1", corev1.ConditionTrue)}}, {nodes: []*corev1.Node{newNodeWithReady("node-0", "v0", "v1", corev1.ConditionTrue), newNodeWithReady("node-1", "v1", "v1", corev1.ConditionTrue), newNodeWithReady("node-2", "v1", "v1", corev1.ConditionFalse)}, currentConfig: "v1", ready: []*corev1.Node{newNodeWithReady("node-1", "v1", "v1", corev1.ConditionTrue)}}, {nodes: []*corev1.Node{newNodeWithReady("node-0", "v0", "v1", corev1.ConditionTrue), newNodeWithReady("node-1", "v1", "v1", corev1.ConditionTrue), newNodeWithReady("node-2", "v1", "v1", corev1.ConditionTrue)}, currentConfig: "v1", ready: []*corev1.Node{newNodeWithReady("node-1", "v1", "v1", corev1.ConditionTrue), newNodeWithReady("node-2", "v1", "v1", corev1.ConditionTrue)}}, {nodes: []*corev1.Node{newNode("node-0", "v0", "v1"), newNode("node-1", "v1", "v1"), newNodeWithReady("node-2", "v1", "v1", corev1.ConditionFalse)}, currentConfig: "v1", ready: []*corev1.Node{newNode("node-1", "v1", "v1")}}}
	for idx, test := range tests {
		t.Run(fmt.Sprintf("case#%d", idx), func(t *testing.T) {
...
func TestGetUnavailableMachines(t *testing.T) {
	...
	tests := []struct {
		...
		currentConfig	string
		unavail		[]*corev1.Node
	}{{nodes: []*corev1.Node{}, currentConfig: "v1", unavail: nil}, {nodes: []*corev1.Node{newNodeWithReady("node-0", "v0", "v0", corev1.ConditionTrue), newNodeWithReady("node-1", "v1", "v1", corev1.ConditionTrue), newNodeWithReady("node-2", "v0", "v1", corev1.ConditionTrue)}, currentConfig: "v1", unavail: []*corev1.Node{newNodeWithReady("node-2", "v0", "v1", corev1.ConditionTrue)}}, {nodes: []*corev1.Node{newNodeWithReady("node-0", "v0", "v0", corev1.ConditionTrue), newNodeWithReady("node-1", "v1", "v1", corev1.ConditionFalse), newNodeWithReady("node-2", "v0", "v1", corev1.ConditionTrue)}, currentConfig: "v1", unavail: []*corev1.Node{newNodeWithReady("node-1", "v1", "v1", corev1.ConditionFalse), newNodeWithReady("node-2", "v0", "v1", corev1.ConditionTrue)}}, {nodes: []*corev1.Node{newNodeWithReady("node-0", "v0", "v1", corev1.ConditionTrue), newNodeWithReady("node-1", "v2", "v2", corev1.ConditionTrue), newNodeWithReady("node-2", "v0", "v2", corev1.ConditionTrue)}, currentConfig: "v2", unavail: []*corev1.Node{newNodeWithReady("node-2", "v0", "v2", corev1.ConditionTrue)}}, {nodes: []*corev1.Node{newNodeWithReady("node-0", "v0", "v1", corev1.ConditionFalse), newNodeWithReady("node-1", "v2", "v2", corev1.ConditionTrue), newNodeWithReady("node-2", "v0", "v2", corev1.ConditionTrue)}, currentConfig: "v2", unavail: []*corev1.Node{newNodeWithReady("node-2", "v0", "v2", corev1.ConditionTrue)}}, {nodes: []*corev1.Node{newNodeWithReady("node-0", "v0", "v1", corev1.ConditionTrue), newNodeWithReady("node-1", "v1", "v1", corev1.ConditionTrue), newNodeWithReady("node-2", "v1", "v1", corev1.ConditionFalse)}, currentConfig: "v1", unavail: []*corev1.Node{newNodeWithReady("node-0", "v0", "v1", corev1.ConditionTrue), newNodeWithReady("node-2", "v1", "v1", corev1.ConditionFalse)}}, {nodes: []*corev1.Node{newNode("node-0", "v0", "v1"), newNode("node-1", "v1", "v1"), newNodeWithReady("node-2", "v1", "v1", corev1.ConditionFalse)}, currentConfig: "v1", unavail: []*corev1.Node{newNode("node-0", "v0", "v1"), newNodeWithReady("node-2", "v1", "v1", corev1.ConditionFalse)}}}
	for idx, test := range tests {
		t.Run(fmt.Sprintf("case#%d", idx), func(t *testing.T) {
...
func TestCalculateStatus(t *testing.T) {
	...
	}{{nodes: []*corev1.Node{newNodeWithReady("node-0", "v0", "v0", corev1.ConditionTrue), newNodeWithReady("node-1", "v0", "v0", corev1.ConditionTrue), newNodeWithReady("node-2", "v0", "v0", corev1.ConditionTrue)}, currentConfig: "v1", verify: func(status mcfgv1.MachineConfigPoolStatus, t *testing.T) {
	...
	}}, {nodes: []*corev1.Node{newNodeWithReady("node-0", "v0", "v1", corev1.ConditionTrue), newNodeWithReady("node-1", "v0", "v0", corev1.ConditionTrue), newNodeWithReady("node-2", "v0", "v0", corev1.ConditionTrue)}, currentConfig: "v1", verify: func(status mcfgv1.MachineConfigPoolStatus, t *testing.T) {
		if got, want := status.MachineCount, int32(3); got != want {
			t.Fatalf("mismatch MachineCount: got %d want: %d", got, want)
		}
		if got, want := status.UpdatedMachineCount, int32(0); got != want {
	...
	}}, {nodes: []*corev1.Node{newNodeWithReady("node-0", "v0", "v1", corev1.ConditionFalse), newNodeWithReady("node-1", "v0", "v0", corev1.ConditionTrue), newNodeWithReady("node-2", "v0", "v0", corev1.ConditionTrue)}, currentConfig: "v1", verify: func(status mcfgv1.MachineConfigPoolStatus, t *testing.T) {
		if got, want := status.MachineCount, int32(3); got != want {
			t.Fatalf("mismatch MachineCount: got %d want: %d", got, want)
		}
		if got, want := status.UpdatedMachineCount, int32(0); got != want {
	...
	}}, {nodes: []*corev1.Node{newNodeWithReadyAndDaemonState("node-0", "v0", "v1", corev1.ConditionFalse, daemonconsts.MachineConfigDaemonStateDegraded), newNodeWithReady("node-1", "v0", "v0", corev1.ConditionTrue), newNodeWithReady("node-2", "v0", "v0", corev1.ConditionTrue)}, currentConfig: "v1", verify: func(status mcfgv1.MachineConfigPoolStatus, t *testing.T) {
		if got, want := status.MachineCount, int32(3); got != want {
			t.Fatalf("mismatch MachineCount: got %d want: %d", got, want)
		}
		if got, want := status.UpdatedMachineCount, int32(0); got != want {
	...
	}}, {nodes: []*corev1.Node{newNodeWithReady("node-0", "v1", "v1", corev1.ConditionFalse), newNodeWithReady("node-1", "v0", "v0", corev1.ConditionTrue), newNodeWithReady("node-2", "v0", "v0", corev1.ConditionTrue)}, currentConfig: "v1", verify: func(status mcfgv1.MachineConfigPoolStatus, t *testing.T) {
		if got, want := status.MachineCount, int32(3); got != want {
			t.Fatalf("mismatch MachineCount: got %d want: %d", got, want)
		}
	...
	}}, {nodes: []*corev1.Node{newNodeWithReady("node-0", "v1", "v1", corev1.ConditionTrue), newNodeWithReady("node-1", "v0", "v1", corev1.ConditionTrue), newNodeWithReady("node-2", "v0", "v1", corev1.ConditionTrue)}, currentConfig: "v1", verify: func(status mcfgv1.MachineConfigPoolStatus, t *testing.T) {
		if got, want := status.MachineCount, int32(3); got != want {
			t.Fatalf("mismatch MachineCount: got %d want: %d", got, want)
		}
		if got, want := status.UpdatedMachineCount, int32(1); got != want {
	...
	}}, {nodes: []*corev1.Node{newNodeWithReady("node-0", "v1", "v1", corev1.ConditionTrue), newNodeWithReady("node-1", "v1", "v1", corev1.ConditionTrue), newNodeWithReady("node-2", "v1", "v1", corev1.ConditionTrue)}, currentConfig: "v1", verify: func(status mcfgv1.MachineConfigPoolStatus, t *testing.T) {
		if got, want := status.MachineCount, int32(3); got != want {
			t.Fatalf("mismatch MachineCount: got %d want: %d", got, want)
		}
	...
	for idx, test := range tests {
		t.Run(fmt.Sprintf("case#%d", idx), func(t *testing.T) {
			pool := &mcfgv1.MachineConfigPool{Status: mcfgv1.MachineConfigPoolStatus{Configuration: mcfgv1.MachineConfigPoolStatusConfiguration{ObjectReference: corev1.ObjectReference{Name: test.currentConfig}}}}
