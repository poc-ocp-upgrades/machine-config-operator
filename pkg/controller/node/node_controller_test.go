...
func (f *fixture) newController() *Controller {
	...
	c := New(i.Machineconfiguration().V1().MachineConfigPools(), k8sI.Core().V1().Nodes(), f.kubeclient, f.client)
...
func TestGetPoolForNode(t *testing.T) {
	...
	tests := []struct {
		...
		err		bool
	}{{pools: []*mcfgv1.MachineConfigPool{newMachineConfigPool("master", metav1.AddLabelToSelector(&metav1.LabelSelector{}, "node-role", "master"), nil, "v0"), newMachineConfigPool("worker", metav1.AddLabelToSelector(&metav1.LabelSelector{}, "node-role", "worker"), nil, "v0")}, nodeLabel: map[string]string{"node-role": ""}, expected: nil, err: false}, {pools: []*mcfgv1.MachineConfigPool{newMachineConfigPool("master", metav1.AddLabelToSelector(&metav1.LabelSelector{}, "node-role", "master"), nil, "v0"), newMachineConfigPool("worker", metav1.AddLabelToSelector(&metav1.LabelSelector{}, "node-role", "worker"), nil, "v0")}, nodeLabel: map[string]string{"node-role": "master"}, expected: newMachineConfigPool("master", metav1.AddLabelToSelector(&metav1.LabelSelector{}, "node-role", "master"), nil, "v0"), err: false}, {pools: []*mcfgv1.MachineConfigPool{newMachineConfigPool("master", metav1.AddLabelToSelector(&metav1.LabelSelector{}, "node-role/master", ""), nil, "v0"), newMachineConfigPool("worker", metav1.AddLabelToSelector(&metav1.LabelSelector{}, "node-role/worker", ""), nil, "v0")}, nodeLabel: map[string]string{"node-role/master": "", "node-role/worker": ""}, expected: newMachineConfigPool("master", metav1.AddLabelToSelector(&metav1.LabelSelector{}, "node-role/master", ""), nil, "v0"), err: false}, {pools: []*mcfgv1.MachineConfigPool{newMachineConfigPool("master", metav1.AddLabelToSelector(&metav1.LabelSelector{}, "node-role/master", ""), nil, "v0"), newMachineConfigPool("worker", metav1.AddLabelToSelector(&metav1.LabelSelector{}, "node-role/worker", ""), nil, "v0"), newMachineConfigPool("infra", metav1.AddLabelToSelector(&metav1.LabelSelector{}, "node-role/infra", ""), nil, "v0")}, nodeLabel: map[string]string{"node-role/worker": "", "node-role/infra": ""}, expected: newMachineConfigPool("infra", metav1.AddLabelToSelector(&metav1.LabelSelector{}, "node-role/infra", ""), nil, "v0"), err: false}, {pools: []*mcfgv1.MachineConfigPool{newMachineConfigPool("master", metav1.AddLabelToSelector(&metav1.LabelSelector{}, "node-role/master", ""), nil, "v0"), newMachineConfigPool("worker", metav1.AddLabelToSelector(&metav1.LabelSelector{}, "node-role/worker", ""), nil, "v0"), newMachineConfigPool("infra", metav1.AddLabelToSelector(&metav1.LabelSelector{}, "node-role/infra", ""), nil, "v0")}, nodeLabel: map[string]string{"node-role/master": "", "node-role/infra": ""}, expected: nil, err: true}, {pools: []*mcfgv1.MachineConfigPool{newMachineConfigPool("master", metav1.AddLabelToSelector(&metav1.LabelSelector{}, "node-role/master", ""), nil, "v0"), newMachineConfigPool("worker", metav1.AddLabelToSelector(&metav1.LabelSelector{}, "node-role/worker", ""), nil, "v0"), newMachineConfigPool("infra", metav1.AddLabelToSelector(&metav1.LabelSelector{}, "node-role/infra", ""), nil, "v0"), newMachineConfigPool("infra2", metav1.AddLabelToSelector(&metav1.LabelSelector{}, "node-role/infra2", ""), nil, "v0")}, nodeLabel: map[string]string{"node-role/infra": "", "node-role/infra2": ""}, expected: nil, err: true}, {pools: []*mcfgv1.MachineConfigPool{newMachineConfigPool("test-cluster-pool-1", metav1.AddLabelToSelector(&metav1.LabelSelector{}, "node-role", "master"), nil, "v0"), newMachineConfigPool("test-cluster-pool-2", metav1.AddLabelToSelector(&metav1.LabelSelector{}, "node-role", "master"), nil, "v0")}, nodeLabel: map[string]string{"node-role": "master"}, expected: nil, err: true}}
...
func intStrPtr(obj intstr.IntOrString) *intstr.IntOrString {
	_logClusterCodePath()
	defer _logClusterCodePath()
	_logClusterCodePath()
	defer _logClusterCodePath()
...
func TestMaxUnavailable(t *testing.T) {
	...
	_logClusterCodePath()
	defer _logClusterCodePath()
	nodes := []*corev1.Node{newNode("node-0", "", ""), newNode("node-1", "", ""), newNode("node-2", "", ""), newNode("node-3", "", "")}
	tests := []struct {
		maxUnavail	*intstr.IntOrString
		expected	int
		err		bool
	}{{maxUnavail: nil, expected: 1, err: false}, {maxUnavail: intStrPtr(intstr.FromInt(2)), expected: 2, err: false}, {maxUnavail: intStrPtr(intstr.FromInt(0)), expected: 1, err: false}, {maxUnavail: intStrPtr(intstr.FromString("50%")), expected: 2, err: false}, {maxUnavail: intStrPtr(intstr.FromString("60%")), expected: 2, err: false}, {maxUnavail: intStrPtr(intstr.FromString("50 percent")), expected: 0, err: true}}
	for idx, test := range tests {
		t.Run(fmt.Sprintf("case#%d", idx), func(t *testing.T) {
			pool := &mcfgv1.MachineConfigPool{Spec: mcfgv1.MachineConfigPoolSpec{MaxUnavailable: test.maxUnavail}}
...
func TestGetCandidateMachines(t *testing.T) {
	...
	}{{progress: 1, nodes: []*corev1.Node{newNodeWithReady("node-0", "v1", "v1", corev1.ConditionTrue), newNodeWithReady("node-1", "v1", "v1", corev1.ConditionTrue), newNodeWithReady("node-2", "v1", "v1", corev1.ConditionTrue)}, expected: nil}, {progress: 1, nodes: []*corev1.Node{newNodeWithReady("node-0", "v1", "v1", corev1.ConditionTrue), newNodeWithReady("node-1", "v1", "v1", corev1.ConditionTrue), newNodeWithReady("node-2", "v1", "v1", corev1.ConditionFalse)}, expected: nil}, {progress: 1, nodes: []*corev1.Node{newNodeWithReady("node-0", "v1", "v1", corev1.ConditionTrue), newNodeWithReady("node-1", "v1", "v1", corev1.ConditionFalse), newNodeWithReady("node-2", "v0", "v1", corev1.ConditionTrue)}, expected: nil}, {progress: 2, nodes: []*corev1.Node{newNodeWithReady("node-0", "v1", "v1", corev1.ConditionTrue), newNodeWithReady("node-1", "v1", "v1", corev1.ConditionFalse), newNodeWithReady("node-2", "v0", "v1", corev1.ConditionTrue), newNodeWithReady("node-3", "v0", "v0", corev1.ConditionTrue), newNodeWithReady("node-4", "v0", "v0", corev1.ConditionTrue)}, expected: []*corev1.Node{newNodeWithReady("node-3", "v0", "v0", corev1.ConditionTrue), newNodeWithReady("node-4", "v0", "v0", corev1.ConditionTrue)}}, {progress: 1, nodes: []*corev1.Node{newNodeWithReady("node-0", "v1", "v1", corev1.ConditionTrue), newNodeWithReady("node-1", "v1", "v1", corev1.ConditionFalse), newNodeWithReady("node-2", "v0", "v1", corev1.ConditionTrue), newNodeWithReady("node-3", "v0", "v0", corev1.ConditionTrue), newNodeWithReady("node-4", "v0", "v0", corev1.ConditionTrue)}, expected: []*corev1.Node{newNodeWithReady("node-3", "v0", "v0", corev1.ConditionTrue)}}, {progress: 1, nodes: []*corev1.Node{newNodeWithReady("node-0", "v1", "v1", corev1.ConditionTrue), newNodeWithReady("node-1", "v0.1", "v0.2", corev1.ConditionFalse), newNodeWithReady("node-2", "v0", "v0", corev1.ConditionTrue)}, expected: []*corev1.Node{newNodeWithReady("node-1", "v0.1", "v0.2", corev1.ConditionFalse)}}}
	for idx, test := range tests {
		t.Run(fmt.Sprintf("case#%d", idx), func(t *testing.T) {
			pool := &mcfgv1.MachineConfigPool{Status: mcfgv1.MachineConfigPoolStatus{Configuration: mcfgv1.MachineConfigPoolStatusConfiguration{ObjectReference: corev1.ObjectReference{Name: "v1"}}}}
...
func TestMakeProgress(t *testing.T) {
	...
	tests := []struct {
		...
		expected	int
	}{{nodes: []*corev1.Node{newNodeWithReady("node-0", "v1", "v1", corev1.ConditionTrue), newNodeWithReady("node-1", "v1", "v1", corev1.ConditionFalse), newNodeWithReady("node-2", "v0", "v1", corev1.ConditionTrue), newNodeWithReady("node-3", "v0", "v0", corev1.ConditionTrue)}, max: intstr.FromInt(2), expected: 0}, {nodes: []*corev1.Node{newNodeWithReady("node-0", "v1", "v1", corev1.ConditionTrue), newNodeWithReady("node-1", "v1", "v1", corev1.ConditionFalse), newNodeWithReady("node-2", "v0", "v1", corev1.ConditionTrue), newNodeWithReady("node-3", "v0", "v0", corev1.ConditionTrue)}, max: intstr.FromString("30%"), expected: 0}, {nodes: []*corev1.Node{newNodeWithReady("node-0", "v1", "v1", corev1.ConditionTrue), newNodeWithReady("node-1", "v1", "v1", corev1.ConditionFalse), newNodeWithReady("node-2", "v0", "v1", corev1.ConditionTrue), newNodeWithReady("node-3", "v0", "v0", corev1.ConditionTrue)}, max: intstr.FromString("50%"), expected: 0}, {nodes: []*corev1.Node{newNodeWithReady("node-0", "v1", "v1", corev1.ConditionTrue), newNodeWithReady("node-1", "v1", "v1", corev1.ConditionTrue), newNodeWithReady("node-2", "v0", "v1", corev1.ConditionTrue), newNodeWithReady("node-3", "v0", "v0", corev1.ConditionTrue)}, max: intstr.FromString("50%"), expected: 1}, {nodes: []*corev1.Node{newNodeWithReady("node-0", "v1", "v1", corev1.ConditionTrue), newNodeWithReady("node-1", "v1", "v1", corev1.ConditionTrue), newNodeWithReady("node-2", "v0", "v1", corev1.ConditionTrue), newNodeWithReady("node-3", "v0", "v0", corev1.ConditionTrue)}, max: intstr.FromInt(2), expected: 1}}
	for idx, test := range tests {
		t.Run(fmt.Sprintf("case#%d", idx), func(t *testing.T) {
			pool := &mcfgv1.MachineConfigPool{Spec: mcfgv1.MachineConfigPoolSpec{MaxUnavailable: &test.max}, Status: mcfgv1.MachineConfigPoolStatus{Configuration: mcfgv1.MachineConfigPoolStatusConfiguration{ObjectReference: corev1.ObjectReference{Name: "v1"}}}}
...
func TestSetDesiredMachineConfigAnnotation(t *testing.T) {
	...
	}{{node: newNode("node-0", "", ""), verify: func(actions []core.Action, t *testing.T) {
		if len(actions) != 2 {
			t.Fatal(actions)
		}
	...
	}}, {node: newNode("node-0", "", ""), extraannos: map[string]string{"test": "extra-annotation"}, verify: func(actions []core.Action, t *testing.T) {
		if len(actions) != 2 {
			t.Fatal(actions)
		}
		if !actions[0].Matches("get", "nodes") || actions[0].(core.GetAction).GetName() != "node-0" {
	...
	}}, {node: newNode("node-0", "v0", ""), verify: func(actions []core.Action, t *testing.T) {
		if len(actions) != 2 {
			t.Fatal(actions)
		}
		if !actions[0].Matches("get", "nodes") || actions[0].(core.GetAction).GetName() != "node-0" {
	...
	}}, {node: newNode("node-0", "v0", ""), extraannos: map[string]string{"test": "extra-annotation"}, verify: func(actions []core.Action, t *testing.T) {
		if len(actions) != 2 {
			t.Fatal(actions)
		}
		if !actions[0].Matches("get", "nodes") || actions[0].(core.GetAction).GetName() != "node-0" {
	...
	}}, {node: newNode("node-0", "v0", "v0"), verify: func(actions []core.Action, t *testing.T) {
		if len(actions) != 2 {
			t.Fatal(actions)
		}
		if !actions[0].Matches("get", "nodes") || actions[0].(core.GetAction).GetName() != "node-0" {
	...
	}}, {node: newNode("node-0", "v0", "v0"), extraannos: map[string]string{"test": "extra-annotation"}, verify: func(actions []core.Action, t *testing.T) {
		if len(actions) != 2 {
			t.Fatal(actions)
		}
		if !actions[0].Matches("get", "nodes") || actions[0].(core.GetAction).GetName() != "node-0" {
	...
	}}, {node: newNode("node-0", "v0", "v1"), verify: func(actions []core.Action, t *testing.T) {
		if len(actions) != 1 {
			t.Fatal(actions)
		}
		if !actions[0].Matches("get", "nodes") || actions[0].(core.GetAction).GetName() != "node-0" {
	...
	}}, {node: newNode("node-0", "v0", "v1"), extraannos: map[string]string{"test": "extra-annotation"}, verify: func(actions []core.Action, t *testing.T) {
		if len(actions) != 1 {
			t.Fatal(actions)
		}
		if !actions[0].Matches("get", "nodes") || actions[0].(core.GetAction).GetName() != "node-0" {
...
func TestShouldUpdateStatusOnlyNoProgress(t *testing.T) {
	...
	f := newFixture(t)
	mcp := newMachineConfigPool("test-cluster-master", metav1.AddLabelToSelector(&metav1.LabelSelector{}, "node-role", "master"), intStrPtr(intstr.FromInt(1)), "v1")
	nodes := []*corev1.Node{newNodeWithLabel("node-0", "v1", "v1", map[string]string{"node-role": "master"}), newNodeWithLabel("node-1", "v0", "v1", map[string]string{"node-role": "master"})}
	f.mcpLister = append(f.mcpLister, mcp)
	f.objects = append(f.objects, mcp)
	f.nodeLister = append(f.nodeLister, nodes...)
	for idx := range nodes {
