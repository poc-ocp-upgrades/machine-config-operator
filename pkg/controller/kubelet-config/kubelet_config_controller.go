...
func (ctrl *Controller) syncKubeletConfig(key string) error {
	...
	for _, pool := range mcpPools {
		...
		mc.ObjectMeta.OwnerReferences = []metav1.OwnerReference{metav1.OwnerReference{APIVersion: mcfgv1.SchemeGroupVersion.String(), Kind: "KubeletConfig", Name: cfg.Name, UID: cfg.UID}}
